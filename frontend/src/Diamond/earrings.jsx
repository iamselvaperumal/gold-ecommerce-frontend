...
<h1 style={{ margin: 0, fontSize: '36px', fontWeight: 900, letterSpacing: '-0.5px', color: '#020617', fontFamily: '"Playfair Display", Georgia, serif', display: 'flex', alignItems: 'center', gap: '10px' }}>
  <svg width="36" height="36" viewBox="0 0 32 32" fill="none" stroke="#67e8f9" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 4l10 8-10 16L6 12z"/>
    <path d="M6 12h20"/>
    <path d="M11 12l5 16"/>
    <path d="M21 12l-5 16"/>
    <path d="M6 12l5-8"/>
...
const hasDiscount = discountPct > 0 && originalAmt > price && price > 0
  ...
  {hasDiscount && (
    <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 13, color: '#2ecc71', fontWeight: 700, marginBottom: 6 }}>
