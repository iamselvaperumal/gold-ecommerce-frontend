...
export default function DiamondRings() {
  ...
  useEffect(() => {
    import('../api').then(({ default: api }) => {
      api.get('/jewelry-products/?category=rings&metal=diamond')
      ...
      <div style={{ padding: '40px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '20px' }}>
          {loading ? (
            ...
            <div style={{ gridColumn: 'span 3', textAlign: 'center', color: '#64748b', padding: '60px 0' }}>No diamond rings found.</div>
            ...
            return (
              <div key={product.id} className="dm-card"
                onClick={() => navigate(`/product-display?category=rings&metal=diamond&id=${product.id}`)}
