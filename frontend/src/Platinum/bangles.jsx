...
export default function PlatinumBangles() {
  ...
  useEffect(() => {
    import('../api').then(({ default: api }) => {
      api.get('/jewelry-products/?category=bangles&metal=platinum')
...
<div style={{ width:'100%', position:'relative', marginBottom:'32px' }}>
  <img src="/banners/platinum_banhgles.png" alt="Platinum Bangles Banner"
    ...
    Platinum Bangles
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '20px' }}>
          {loading ? (
            ...
            <div style={{ gridColumn: 'span 3', textAlign: 'center', color: '#64748b', padding: '60px 0' }}>No platinum bangles found.</div>
