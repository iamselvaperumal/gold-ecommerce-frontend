...
return (
  <div style={{ minHeight: '100vh', background: bg, color: text, fontFamily: '"Inter",system-ui,sans-serif', position: 'relative', overflow: 'hidden' }}>
    <style>{`
      ...
      .ge-shine { position:absolute; top:0; left:-80%; width:40%; height:100%; background:linear-gradient(90deg,transparent,rgba(255,255,255,0.18),transparent); transform:skewX(-20deg); opacity:0; transition:opacity 0.3s; }
  ...
  className="ge-card"
  onClick={() =>
    navigate(`/product-display?category=earrings&metal=gold&id=${item.id}`)
  }
  ...
  onMouseLeave={() => setHoveredItem(null)}
              ...
              >
                ...
                <div className="ge-img-wrap" style={{ position: 'relative', height: '200px', background: 'rgba(0,0,0,0.04)' }}>
<img
