...
return (
  <div style={{ minHeight:'100vh', background:bg, color:text, fontFamily:'"Inter",system-ui,sans-serif', position:'relative', overflow:'hidden' }}>
    <style>{`
      ...
      .sr-card:nth-child(1){animation-delay:0.05s} .sr-card:nth-child(2){animation-delay:0.12s}
      .sr-card:nth-child(3){animation-delay:0.19s} .sr-card:nth-child(4){animation-delay:0.26s}
    ...
    No silver rings added yet.
            ...
            return (
              ...
              >
                ...
                {/* Image */}
                <div className="sr-img-wrap" style={{ position:'relative', height:'200px', background: 'rgba(0,0,0,0.04)' }}>
                  <img
            ...
            <div style={{ padding:'28px 32px' }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
                ...
                <button
                  ...
                  style={{ width:'100%', padding:'12px', background:'rgba(192,192,192,0.08)', border:'1px solid rgba(192,192,192,0.3)', borderRadius:'14px', color:'#c0c0c0', fontWeight:700, fontSize:'13px', cursor:'pointer' }}
                >
